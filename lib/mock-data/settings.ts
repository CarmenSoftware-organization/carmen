...
export const mockEmailTemplates: EmailTemplate[] = [
  {
    ...
    variables: [
      ...
      { name: 'requestId', description: 'Purchase request ID', example: 'PR-2024-001', required: true },
  ...
  },
  {
    ...
    variables: [
      { name: 'recipientName', description: 'Recipient name', example: 'John Doe', required: true },
      { name: 'invoiceId', description: 'Invoice number', example: 'INV-2024-001', required: true },
...
export const mockNotificationLogs: NotificationLog[] = [
  {
    ...
    metadata: { requestId: 'PR-2024-123' },
    retryCount: 0,
    sentAt: new Date('2024-10-21T08:30:00'),
    recipient: 'manager@carmen.com',
    subject: 'New Purchase Request #PR-2024-123 Submitted',
    attempts: 1,
    maxAttempts: 3
  },
  {
    ...
    metadata: { invoiceId: 'INV-2024-456' },
    retryCount: 0,
    sentAt: new Date('2024-10-21T09:15:00'),
    recipient: 'finance@carmen.com',
    subject: 'Payment Due: Invoice #INV-2024-456',
    attempts: 1,
    maxAttempts: 3
  },
  {
  ...
  },
  {
    ...
    metadata: { requestId: 'PR-2024-124' },
    retryCount: 0,
    sentAt: new Date('2024-10-21T11:30:00'),
    recipient: 'purchasing@carmen.com',
    subject: 'Purchase Request #PR-2024-124 Approved',
    attempts: 1,
    maxAttempts: 3
  },
  {
  ...
  },
  {
    ...
    metadata: { invoiceId: 'INV-2024-457', vendorId: 'VEN-002' },
    retryCount: 0,
    sentAt: new Date('2024-10-21T14:15:00'),
    recipient: 'finance@carmen.com',
    subject: 'New Invoice Received: #INV-2024-457',
    attempts: 1,
    maxAttempts: 3
  },
  {
    ...
    metadata: { orderId: 'PO-2024-001', totalAmount: 15000 },
    retryCount: 0,
    sentAt: new Date('2024-10-21T15:30:00'),
    recipient: 'vendor@supplier.com',
    subject: 'Purchase Order #PO-2024-001 Created',
    attempts: 1,
    maxAttempts: 3
  },
  {
    ...
    metadata: { countId: 'COUNT-2024-010', dueDate: '2024-10-25' },
    retryCount: 0,
    sentAt: new Date('2024-10-21T16:00:00'),
    recipient: 'warehouse@carmen.com',
    subject: 'Stock Count Due: COUNT-2024-010',
    attempts: 1,
    maxAttempts: 3
  },
  {
