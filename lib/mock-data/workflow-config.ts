import {
  ...
  Workflow,
  Product
} from "@/app/(main)/system-administration/workflow/workflow-configuration/types/workflow"
import { roles } from "./role-assignments"
...
export const sampleWorkflows: Workflow[] = [
  {
    ...
    stages: [
      { 
        ...
        assignedUsers: mockUsers.slice(0, 2), // First 2 users
        roleType: "requester"
      },
      { 
        id: 2, 
        ...
        assignedUsers: mockUsers.slice(2, 4), // Next 2 users
        roleType: "purchaser"
      },
      { 
        id: 3, 
...
export const mockWorkflowRoutingRules: RoutingRule[] = sampleWorkflows[0].routingRules
