// Mock data for inventory/warehouse locations
// Note: This is different from the Location type in lib/types/user.ts which represents physical building locations
