      ...
      if (stockBalances.length === 0) {
        return {
          ...
          data: {
            ...
            valuationMethod: filters.costingMethod || CostingMethod.PERIODIC_AVERAGE,
            valuationDate,
            byLocation: [],
            byCategory: [],
            alerts: [],
    ...
    try {
      ...
      for (const balance of stockBalances) {
        ...
        analyses.push({
          ...
          costingMethod: (balance.inventory_items?.costing_method as CostingMethod) || CostingMethod.PERIODIC_AVERAGE,
          currentCost,
          standardCost,
