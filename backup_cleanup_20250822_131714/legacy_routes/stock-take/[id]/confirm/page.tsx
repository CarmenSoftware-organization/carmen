...
export default function StockTakeConfirmationPage({ params }: { params: { id: string } }) {
      ...
      <div className="container max-w-md mx-auto pt-20 pb-20 px-4 flex flex-col items-center justify-center min-h-[70vh]">
        <Card className="w-full">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-xl">Stock Take Completed</CardTitle>
          </CardHeader>
          <CardContent className="text-center pb-2">
            <p className="text-muted-foreground">You have successfully completed the stock take session.</p>
