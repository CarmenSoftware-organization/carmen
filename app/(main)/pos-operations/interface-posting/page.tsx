  ...
  const [transactions, setTransactions] = useState<InterfaceTransaction[]>([
    {
      ...
      records: 150,
      source: "Comanche POS",
      details: "Daily sales transactions"
    },
    {
      id: "TRX-002",
      timestamp: new Date(),
      ...
      records: 75,
      source: "Comanche POS",
      details: "Stock movement updates"
    }
  ])
  ...
  return (
    <div className="flex-1 space-y-4 px-2 py-4 md:px-4 md:py-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Interface Posting</h2>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Interface Posts</CardTitle>
        </CardHeader>
        <CardContent>
