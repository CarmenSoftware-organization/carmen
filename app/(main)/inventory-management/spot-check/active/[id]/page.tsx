...
export default function ActiveCountPage({ params }: PageProps) {
  ...
  const handleCompleteCount = () => {
    ...
    console.log('Completing count...');
    router.push('/inventory-management/spot-check/completed');
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <AlertDialog open={showCompleteConfirm} onOpenChange={setShowCompleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Complete Spot Check</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to complete this spot check? This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
