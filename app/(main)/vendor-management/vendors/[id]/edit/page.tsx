...
export default function EditVendorPage({ params }: EditVendorPageProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!vendor.priceCollectionPreferences?.preferredCurrency) {
      errors['priceCollectionPreferences.preferredCurrency'] = 'Preferred currency is required';
    }
    
    if (vendor.priceCollectionPreferences?.defaultLeadTime === undefined || 
        vendor.priceCollectionPreferences.defaultLeadTime < 0) {
      errors['priceCollectionPreferences.defaultLeadTime'] = 'Default lead time must be a non-negative number';
    }
    
    if (!vendor.priceCollectionPreferences?.communicationLanguage) {
      errors['priceCollectionPreferences.communicationLanguage'] = 'Communication language is required';
    }
    
    const notificationPrefs = vendor.priceCollectionPreferences?.notificationPreferences;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edit the basic vendor information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="baseVendorId">Vendor ID</Label>
                <Input
                  id="baseVendorId"
                  value={vendor.baseVendorId}
                  disabled
                />
                <p className="text-sm text-gray-500">Vendor ID cannot be changed</p>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Select
                  value={vendor.priceCollectionPreferences?.preferredCurrency}
                  onValueChange={(value) => 
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  value={vendor.priceCollectionPreferences?.defaultLeadTime}
                  onChange={(e) => 
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={vendor.priceCollectionPreferences?.communicationLanguage}
                  onValueChange={(value) => 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="emailReminders"
                    checked={vendor.priceCollectionPreferences?.notificationPreferences?.emailReminders}
                    onCheckedChange={(checked) => 
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={vendor.priceCollectionPreferences?.notificationPreferences?.reminderFrequency}
                    onValueChange={(value) => 
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    checked={vendor.priceCollectionPreferences?.notificationPreferences?.escalationEnabled}
                    onCheckedChange={(checked) => 
                ...
                {vendor.priceCollectionPreferences?.notificationPreferences?.escalationEnabled && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      type="number"
                      min="1"
                      value={vendor.priceCollectionPreferences?.notificationPreferences?.escalationDays}
                      onChange={(e) => 
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="text"
                    placeholder="09:00"
                    value={vendor.priceCollectionPreferences?.notificationPreferences?.preferredContactTime || ''}
                    onChange={(e) => 
