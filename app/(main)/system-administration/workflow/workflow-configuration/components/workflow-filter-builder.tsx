...
interface WorkflowAdvancedFilterProps {
  onApplyFilters: (filters: WorkflowFilter[]) => void
  onClearFilters: () => void
  activeFiltersCount: number
}

const workflowFields = [
  { value: 'name', label: 'Workflow Name' },
  { value: 'type', label: 'Workflow Type' },
  { value: 'status', label: 'Status' },
  { value: 'description', label: 'Description' },
  { value: 'createdBy', label: 'Created By' },
  { value: 'stageCount', label: 'Stage Count' },
...
export function WorkflowAdvancedFilter({ onApplyFilters, onClearFilters, activeFiltersCount }: WorkflowAdvancedFilterProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create complex filters to find specific workflows.
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="grid grid-cols-12 gap-2 flex-1">
                  <div className="col-span-3">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => 
                        updateFilter(filter.id, { field: value as keyof Workflow })
                      }
                    >
