...
export function StoreRequisitionListComponent() {
  ...
  const requisitions: Requisition[] = [
    { date: '2024-01-15', refNo: 'SR-2024-001', requestTo: 'M01', storeName: 'Main Store', description: 'Monthly supplies request', status: 'In Process' },
    { date: '2024-01-14', refNo: 'SR-2024-002', requestTo: 'B01', storeName: 'Branch Store 1', description: 'Emergency stock replenishment', status: 'Complete' },
    { date: '2024-01-13', refNo: 'SR-2024-003', requestTo: 'M02', storeName: 'Main Store', description: 'Draft Requisition', status: 'Draft' },
    { date: '2024-01-12', refNo: 'SR-2024-004', requestTo: 'B02', storeName: 'Branch Store 2', description: 'Quarterly inventory update', status: 'In Process' },
    { date: '2024-01-11', refNo: 'SR-2024-005', requestTo: 'M01', storeName: 'Main Store', description: 'Office supplies restock', status: 'Complete' },
    { date: '2024-01-10', refNo: 'SR-2024-006', requestTo: 'B03', storeName: 'Branch Store 3', description: 'Emergency equipment request', status: 'Reject' },
    { date: '2024-01-09', refNo: 'SR-2024-007', requestTo: 'M02', storeName: 'Main Store', description: 'IT department supplies', status: 'In Process' },
    { date: '2024-01-08', refNo: 'SR-2024-008', requestTo: 'B01', storeName: 'Branch Store 1', description: 'Seasonal inventory preparation', status: 'Draft' },
    { date: '2024-01-07', refNo: 'SR-2024-009', requestTo: 'M01', storeName: 'Main Store', description: 'Maintenance tools request', status: 'Complete' },
    { date: '2024-01-06', refNo: 'SR-2024-010', requestTo: 'B02', storeName: 'Branch Store 2', description: 'Staff uniform order', status: 'In Process' },
    { date: '2024-01-05', refNo: 'SR-2024-011', requestTo: 'M02', storeName: 'Main Store', description: 'Marketing materials request', status: 'Void' },
    { date: '2024-01-04', refNo: 'SR-2024-012', requestTo: 'B03', storeName: 'Branch Store 3', description: 'Safety equipment restock', status: 'Complete' },
    { date: '2024-01-03', refNo: 'SR-2024-013', requestTo: 'M01', storeName: 'Main Store', description: 'Cleaning supplies order', status: 'In Process' },
    { date: '2024-01-02', refNo: 'SR-2024-014', requestTo: 'B01', storeName: 'Branch Store 1', description: 'New product samples request', status: 'Draft' },
    { date: '2024-01-01', refNo: 'SR-2024-015', requestTo: 'M02', storeName: 'Main Store', description: 'Year-end inventory count supplies', status: 'Complete' },
  ]
