...
export function ItemDetailsComponent({
  ...
  const [isGRNTableOpen, setIsGRNTableOpen] = useState(false)
  ...
  const handleGReceivedClick = () => {
    setIsGRNTableOpen(true)
  }
    ...
    <>
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-center space-x-2">
                ...
                {mode === 'edit' && (
                  <>
                    ...
                    <Button variant="outline" size="sm" onClick={() => handleModeChange('view')}>
                ...
                <CardContent className="pt-2">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input id="name" defaultValue="Organic Quinoa" readOnly={isReadOnly} className="h-7 text-sm" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs font-semibold">USD 1795.50</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs font-semibold">USD 89.78</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs font-semibold">USD 1705.72</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs font-semibold">USD 119.40</div>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
          ...
          <Card>
            <CardContent className="flex flex-wrap justify-end gap-2 py-2">
              ...
              <Button variant="outline" size="sm" onClick={handleGReceivedClick}>
                G. Received
              </Button>
            </CardContent>
          </Card>
      ...
      <Dialog open={isPrItemsTableOpen} onOpenChange={setIsPrItemsTableOpen}>
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Related Purchase Requests</DialogTitle>
          </DialogHeader>
          <PrItemsTable />
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isGRNTableOpen} onOpenChange={setIsGRNTableOpen}>
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Goods Receive Notes</DialogTitle>
          </DialogHeader>
