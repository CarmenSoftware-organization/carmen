...
import DialogPageTemplate from "@/components/templates/DialogPageTemplate";
...
export function PurchaseOrderItemFormComponent({
  ...
  const renderField = (
    ...
    const formattedBaseValue =
      typeof baseValue === "number" && decimals !== undefined
          ...
          <div className="mt-0.5 flex items-center">
            ...
            {baseValue && (
              <span className="text-xs text-gray-500 ml-1">
                ...
                {convRate &&
                  ` Conv: ${(
                    formData.baseQuantity / formData.orderedQuantity
                  ).toFixed(2)}`}
                )
              </span>
            )}
  ...
  const title = <div>Item Details</div>;
  ...
  const content = (
    <>
      <form onSubmit={handleSubmit} className="grid grid-cols-6 gap-2 mt-4">
        <div className="col-span-1">{renderField("Name", "name")}</div>
        <div className="col-span-5">
          {renderField("Description", "description", "textarea")}
        </div>
        <div className="col-span-1">
          {renderField("Order Unit", "itemOrderUnit", "text", "baseUnit", true)}
        </div>
        <div className="col-span-1">
          {renderField(
            "Approved Qty",
        ...
        <div className="col-span-1">
          {renderField("FOC", "foc", "number", "baseFocQty", false, "", 3)}
        </div>
        <div className="col-span-1">
          {renderField(
            "Cancel Qty",
          ...
          <div className="w-full grid grid-cols-3 gap-4">
            ...
            <div className="col-span-1 text-right">
              ...
              <div className="text-xs text-gray-500">
                {formData.baseNetAmount?.toFixed(2)}
              </div>
            </div>
            ...
            <div className="col-span-1">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="adjDiscount" className="ml-2 text-sm">
                  Discount
                </label>
              </div>
            </div>
            ...
            <div className="col-span-1 text-right">
              ...
              <div className="text-xs text-gray-500">
                {formData.baseDiscAmount?.toFixed(2)}
              </div>
            </div>
            ...
            <div className="col-span-1">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="adjTax" className="ml-2 text-sm">
                  Tax
                </label>
              </div>
            </div>
            <div className="col-span-1">
              {renderField("", "taxRate", "number", undefined, undefined, "%")}
            </div>
            <div className="col-span-1 text-right">
              {renderField("", "taxAmount", "number", undefined, false, "", 2)}
              <div className="text-xs text-gray-500">
                {formData.baseTaxAmount?.toFixed(2)}
              </div>
            </div>
            ...
            <div className="col-span-1 text-right">
              ...
              <div className="text-xs text-gray-500">
                {formData.baseTotalAmount?.toFixed(2)}
              </div>
            </div>
          </div>
        </div>
