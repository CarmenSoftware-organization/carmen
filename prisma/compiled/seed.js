...
async function loadSeedData() {
    const seedDataPath = (0, path_1.join)(__dirname, 'seed-data');
    const resourceDefinitions = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'resource-definitions.json'), 'utf8'));
    const environmentDefinitions = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'environment-definitions.json'), 'utf8'));
    const roles = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'sample-roles.json'), 'utf8'));
    const policies = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'sample-policies.json'), 'utf8'));
    const users = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'sample-users.json'), 'utf8'));
    const accessRequests = JSON.parse((0, fs_1.readFileSync)((0, path_1.join)(seedDataPath, 'sample-access-requests.json'), 'utf8'));
    return {
        resourceDefinitions,
...
async function seedResourceDefinitions(data) {
...
async function seedEnvironmentDefinitions(data) {
...
async function seedPolicies(data) {
...
async function seedAccessRequests(data) {
