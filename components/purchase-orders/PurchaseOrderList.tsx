...
const purchaseOrders = [
  ...
  },
  {
    ...
    total: 3000.0,
    status: "Send",
    email: "vendor@bestelectronics.com",
  },
  {
    id: 6,
    number: "PO-006",
  ...
  },
  {
    ...
    total: 2000.25,
    status: "Send",
    email: "vendor@industrialsupplies.com",
  },
  {
    id: 9,
    number: "PO-009",
    ...
    total: 1750.75,
    status: "Closed",
    email: "vendor@techinnovations.com",
  },
  {
    id: 10,
    number: "PO-010",
    ...
    total: 3500.0,
    status: "Partial Received",
    email: "vendor@globaltraders.com",
  },
];
...
const PurchaseOrderList: React.FC = () => {
  ...
  const actionButtons = (
    <>
      ...
      <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant={'default'} >Create PO</Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
            <DropdownMenuItem onSelect={() => setIsCreateFromPROpen(true)}>
              Create from PR
            </DropdownMenuItem>
          ...
          <DropdownMenuContent>
            ...
            {selectedPOs.length > 0 && (
              <>
                {selectedPOs.some(
                  (id) =>
                    currentItems.find((po) => po.id === id)?.status === "Open"
                ) && (
                ...
                {selectedPOs.some((id) =>
                  ["Send", "Partial Received"].includes(
                    currentItems.find((po) => po.id === id)?.status || ""
                  )
                ) && (
                  <DropdownMenuItem onSelect={() => handleBulkAction("void")}>
                    Void Selected
                  </DropdownMenuItem>
                )}
                {selectedPOs.some((id) =>
                  ...
                  <DropdownMenuItem onSelect={() => handleBulkAction("close")}>
                    Close Selected
                  </DropdownMenuItem>
                )}
              </>
